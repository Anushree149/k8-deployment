pipeline {
    ...
    environment {
        ...
        ANSIBLE_HOST_IP = '43.205.126.200'  // Ansible Server IP
        ...
        stage('Docker Build') {
            steps {
                script {
                    sshagent(['ansible']) {
                        sh """
                        ssh -o StrictHostKeyChecking=no ubuntu@${ANSIBLE_HOST_IP} 'cd /home/ubuntu/k8-deployment/kubernetes-devops-project && \
